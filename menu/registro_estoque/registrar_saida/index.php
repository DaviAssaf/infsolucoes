...
<head>
    ...
    <title>Registrar Saida de Estoque</title>
...
<body>
    ...
    <form action="processar_baixa.php" class="form-container" method="POST" id="saidaForm">
        ...
        <div class="form-footer">
            <button type="submit" class="button-submit" id="saidaSubmit">Registrar Saída</button>
        </div>
    </form>
</body>
