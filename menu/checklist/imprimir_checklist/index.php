    ...
    <div class="hidden">
        <div class="container-print">
            ...
            <div class="section info-colab">
                ...
                <p><strong>Retorno:</strong> <?php echo htmlspecialchars($checklist['retorno'] ? date('d/m/Y H:i', strtotime($checklist['retorno'])) : '____/____/________            ____:____'); ?></p>
            </div>
            <?php if ($checklist['veiculo'] != null): ?>
                <div class="section vehicle-section">
                    ...
                    <div class="vehicle-details">
                        ...
                        <p><strong>KM de Saída:</strong> <span><?php echo htmlspecialchars($checklist['km_saida'] ?? '0'); ?></span></p>
                        <p><strong>KM de Retorno:</strong> <span>____________________</span></p>
                    </div>
                </div>
            <?php endif ?>
                ...
                <table class="table-style-print">
                    <thead>
                        <tr>
                            <th>ITEM</th>
                            <th>SAÍDA</th>
                            <th>RETORNO (SOMENTE SE HOUVER EXTRAVIO)</th>
                            <th>RETORNADO</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="obs">
                <p><strong>Observações:</strong><textarea name="" id=""></textarea></p>
            </div>
